  ...
  <div>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="40%" @close="handleDialogClose">
      <el-form :model="mergeForm" :rules="mergeFormRules" ref="mergeForm" :label-position="labelPosition"
        ...
        <el-form-item label="用户类型" prop="usertype">
          <div>
            <el-radio v-model="mergeForm.usertype" label="普通用户" value="1" border size="medium">普通用户</el-radio>
            <el-radio v-model="mergeForm.usertype" label="投资者账户" value="2" border size="medium">投资者账户</el-radio>
          </div>
        </el-form-item>
        <el-form-item label="用户状态" prop="bitstate">
          <div>
            <el-radio v-model="mergeForm.bitstate" label="可用" value="1" border size="medium">可用</el-radio>
            <el-radio v-model="mergeForm.bitstate" label="禁用" value="2" border size="medium" style="margin-left: 40px;">
              禁用
            </el-radio>
          </div>
        </el-form-item>
    ...
    <el-dialog :title="dialogTitle" :visible.sync="dialogVisible02" width="40%" @close="handleDialogClose">
      <el-form :model="mergeForm2" :rules="mergeFormRules02" ref="mergeForm" :label-position="labelPosition"
               label-width="80px">
        <el-form-item label="用户账号" prop="nickname">
          <el-input v-model="mergeForm2.nickname" placeholder="请输入2-10的用户账号"></el-input>
        </el-form-item>
        <el-form-item label="用户密码" prop="userpassword">
          <el-input type="password" v-model="mergeForm2.userpassword" placeholder="请输入6-10的用户密码" autocomplete="off"
                    show-password></el-input>
        </el-form-item>
        <el-form-item label="电话号码" prop="phonenumber">
          <el-input type="text" v-model="mergeForm2.phonenumber" placeholder="请输入确认你输入的密码" autocomplete="off"
          ></el-input>
        </el-form-item>
        <el-form-item label="用户类型" prop="usertype">
          <div>
            <el-radio v-model="mergeForm2.usertype" label="普通用户" value="1" border size="medium">普通用户</el-radio>
            <el-radio v-model="mergeForm2.usertype" label="投资者账户" value="2" border size="medium">投资者账户</el-radio>
          </div>
        </el-form-item>
        <el-form-item label="用户状态" prop="bitstate">
          <div>
            <el-radio v-model="mergeForm2.bitstate" label="可用" value="1" border size="medium">可用</el-radio>
            <el-radio v-model="mergeForm2.bitstate" label="禁用" value="2" border size="medium"
                      style="margin-left: 40px;">禁用
            </el-radio>
          </div>
        </el-form-item>
        <el-form-item label="用户头像" prop="headimage">
          <el-upload v-model="mergeForm2.headimage" class="upload-demo" :limit="2"
                     :auto-upload="false" multiple>
            <el-button size="small" type="primary">选择头像文件</el-button>
          </el-upload>
        </el-form-item>
