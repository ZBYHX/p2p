<template>
  ...
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size: 18px;font-family: '宋体';font-weight: bold;">
      ...
      <el-breadcrumb-item>满标一审</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-form label-width="80px">
      <el-table :data="tableData" stripe style="width: 100%">
        <el-table-column prop="fullID" label="满标一审ID" min-width="10">
        </el-table-column>
        <el-table-column prop="fullName" label="满标审核ID" min-width="15">
        </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="dialogSerFormVisible" @close="clearForm" width="60%">
      <el-form :inline="true" :model="fullBidForm" ref="valide" :rules="mergeFormRules" label-position="left"
               label-width="80px" style="overflow: auto;max-height: 400px;">
        <div>
          <el-form-item label="满标一审ID" v-if="false" prop="fullID">
            <el-input type="hidden" v-model="fullBidForm.fullID" readonly="readonly"></el-input>
          </el-form-item><br />
          <el-form-item label="满标审核ID" prop="fullName">
            <el-input style="width: 300px;" size="20" v-model="fullBidForm.fullName" readonly="readonly"></el-input>
          </el-form-item>
        </div>
        <div>
          <el-form-item label="审核ID" prop="auditorId">
            <el-input style="width: 300px;" v-model="fullBidForm.auditorId" readonly="readonly" ></el-input>
          </el-form-item>
        </div>
        <div>
        </div>
        <div>
          <el-form-item label="审核时间" prop="auditTime">
            <el-col :span="11">
              <el-date-picker type="date" placeholder="选择日期(自动)" v-model="fullBidForm.auditTime" style="width: 80%;"
                              readonly="readonly"></el-date-picker>
            </el-col>
            <el-col class="line" :span="2">-</el-col>
            <el-col :span="11">
              <el-time-picker placeholder="选择时间(自动)" v-model="fullBidForm.tradeTime" style="width: 80%;" readonly="readonly"></el-time-picker>
            </el-col>
          </el-form-item>
          <el-form-item label="备注" prop="remark">
            <el-input type="textarea" rows="12" v-model="fullBidForm.remark" placeholder="请填写您的备注" maxlength="3000"
  ...
  export default {
    data: function() {
      return {
        fullBidForm: {
          fullID:null,//满标一审ID
          fullName: null, //满标审核ID（1=满标一审,2=满标二审)
          auditTime: null, //审核时间
