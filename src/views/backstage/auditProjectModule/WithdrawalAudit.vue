  ...
  <div>
    ...
    <el-form label-width="80px">
      <el-table :data="tableData" stripe style="width: 100%">
        <el-table-column prop="cashId" label="提现ID" min-width="10">
        </el-table-column>
        <el-table-column prop="bankId" label="银行卡号" min-width="15">
        </el-table-column>
        <el-table-column prop="cashMoney" label="提现金额" min-width="15">
        </el-table-column>
        <el-table-column prop="tradeTime" label="交易时间" min-width="15">
        </el-table-column>
        <el-table-column prop="serviceFee" label="平台服务费" min-width="15">
        </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="dialogSerFormVisible" @close="clearForm" width="60%">
      <el-form :inline="true" :model="reChargeForm" ref="valide" :rules="mergeFormRules" label-position="left"
        ...
        <div>
          <el-form-item label="提现ID" v-if="false" prop="cashId">
            <el-input type="hidden" v-model="reChargeForm.cashId" readonly="readonly"></el-input>
          </el-form-item><br />
          ...
          <el-form-item label="提现金额" style="margin-left: 60px;" prop="cashMoney">
            <el-input style="width: 300px;" v-model="reChargeForm.cashMoney" readonly="readonly" placeholder="请选择金额"></el-input>
          </el-form-item>
        </div>
        <div>
          <el-form-item label="平台服务费" style="margin-left: 60px;" prop="serviceFee">
            <el-input style="width: 300px;" v-model="reChargeForm.serviceFee" readonly="readonly" placeholder="请选择金额"></el-input>
          </el-form-item>
