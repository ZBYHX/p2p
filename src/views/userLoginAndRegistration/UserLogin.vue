<template>
  <header>
    ...
    <div class="header min-width">
      <div class="container">
        <div class="fn-left logo"><a class="" href="index.html"> <img src="../frontEnd/static/images/logo.png" title=""> </a></div>
        ...
        <div class="registerCont">
          <ul>
            ...
            <li>
              ...
              <input class="input" type="password" v-model="password" placeholder="" maxlength="24" tabindex="1" autocomplete="off">
            </li>
            <li>
              ...
              <a @click="changeCount()" class="blue myCss01">看不清？换一张</a>
            </li>
            ...
            <li class="btn">
              <el-row>
                <el-button type="success" style="width: 200px;" size="medium" >立即登录</el-button>
              </el-row>
            </li>
          </ul>
        </div>
      ...
      <div class="ft-wap clearfix">
        <dl>
          ...
          <dd><span class="icon-ft-erweima">
            <img src="../frontEnd/static/images/code.png" style="display: inline;"></span>
          </dd>
        </dl>
      </div>
    </div>
