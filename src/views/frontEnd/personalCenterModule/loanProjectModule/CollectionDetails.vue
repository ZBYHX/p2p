<template>
  <header>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right" >
      ...
      <el-breadcrumb-item style="font-size: 20px;">收款明细</el-breadcrumb-item>
    </el-breadcrumb>
    <div style="width: 90%;margin-left: 280px;margin-top: -700px;">
      <el-table :data="result"  height="370px" border  highlight-current-row :summary-method="getSummaries"
        ...
        <el-table-column prop="userName" label="收款人" width="180">
        </el-table-column>
        <el-table-column prop="totalamount"  label="收款总金额(元)" width="180">
        </el-table-column>
        <el-table-column prop="principal"  label="借款本金" width="180">
        </el-table-column>
        <el-table-column prop="deadLineCN" label="截止期限" width="180">
        </el-table-column>
        <el-table-column prop="payDateCN"  label="借款日期" width="180">
        </el-table-column>
        <el-table-column prop="interest" label="投资获利" width="180">
        </el-table-column>
      </el-table>
    </div>
    <!-- 完整分页 -->
