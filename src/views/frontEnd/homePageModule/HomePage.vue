<template>
  <header>
    ...
    <div class="flexslider">
      <ul class="slides">
        <li
          style="background-image: url(../static/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;"
          class=""><a href="#" target="_blank"></a></li>
        <li
          style="background-image: url(../static/images01/t1.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;"
          class=""><a href="#" target="_blank"></a></li>
        <li
          style="background-image: url(../static/images/banner.jpg); width: 100%; float: left; margin-right: -100%; position: relative; opacity: 0; display: block; z-index: 1; background-position: 50% 0px; background-repeat: no-repeat no-repeat;"
          class=""><a href="#" target="_blank"></a></li>
    ...
    <div class="ipubs">
      <span class="o1">累计投资金额:<strong>1,047,288,128.79</strong>元</span> <span
      class="o2">已还本息:<strong>400,507,750.81</strong>元</span><span
      class="o2">余额:<strong>677,679,983.07</strong>元</span><span class="o4">注册人数:<strong>20649</strong>人</span></div>
    ...
    <div class="main clearfix mrt30" data-target="sideMenu">
      ...
      <div class="wrap">
        <div class="page-left fn-left">
          <div class="mod-borrow">
            ...
            <div class="bd">
              <div class="des">
                ...
                <a href="list.html" class="fn-right">查看更多&gt;&gt;</a>
              </div>
                ...
                <ul>
                  <li>
                    <div class="title">
                      <a href="infor.html" target="_blank">
                        <i class="icon icon-zhai" title="债权贷"></i></a>
                      <a href="infor.html" class="f18" title="金女士债权质押借款1万元" target="_blank">
                        金女士债权质押借款1万元</a>
                    </div>
                  ...
                  <li>
                    <div class="title">
                      ...
                      <a href="infor.html" class="f18" title="周先生债权质押借款0.1万元" target="_blank">周先生债权质押借款0.1万元</a>
                    </div>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                      <tr>
          ...
          <div class="mod-borrow mrt20">
            <div class="hd">
              ...
              <div class="fn-right f14 c-888">参与人次：<span class="c-555">61.37万次</span>&nbsp;&nbsp;&nbsp;平均满标时间：<span
                class="c-555">1小时24分11秒</span></div>
            </div>
            <div class="bd">
              <div class="des">
              ...
              <div class="borrow-list">
                <ul>
                  <li>
                    <div class="title"><a href="#" target="_blank"><i class="icon icon-che" title="车易贷"></i></a><a
                      href="infor.html" class="f18" title="毕先生宝马320汽车质押贷款10万元" target="_blank">毕先生宝马320汽车质押贷款10万元</a>
                    </div>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                      <tr>
                  ...
                  <li>
                    <div class="title"><a href="infor.html" target="_blank"><i class="icon icon-che"
                                                                               title="车易贷"></i></a><a
                      href="#" class="f18" title="王先生克莱斯勒300C汽车质押贷款15万元" target="_blank">王先生克莱斯勒300C汽车质押贷款15万元</a>
                    </div>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                      <tr>
          ...
          <div class="mod-borrow mrt20">
            <div class="hd">
              ...
              <div class="fn-right f14 c-888">参与人次：<span class="c-555">8.35万次</span>&nbsp;&nbsp;&nbsp;平均满标时间：<span
                class="c-555">1小时41分19秒</span></div>
            </div>
            <div class="bd">
              <div class="des">
                <span class="fn-left">期限12-60月，打理更加容易</span>
                <a href="list.html" class="fn-right">查看更多&gt;&gt;</a>
              </div>
              <div class="borrow-list">
                <ul>
                  <li>
                    <div class="title"><a href="infor.html" target="_blank"><i class="icon icon-che"
                                                                               title="车易贷"></i></a><a
                      href="infor.html" class="f18" title="朱先生比亚迪S6汽车抵押贷款4.5万元"
                      target="_blank">朱先生比亚迪S6汽车抵押贷款4.5万元</a></div>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                      <tr>
                  ...
                  <li>
                    <div class="title"><a href="infor.html" target="_blank"><i class="icon icon-che"
                                                                               title="车易贷"></i></a><a
                      href="infor.html" class="f18" title="朱先生别克英朗汽车抵押贷款5万元" target="_blank">朱先生别克英朗汽车抵押贷款5万元</a>
                    </div>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                      <tr>
          ...
          <div class="mod-borrow mrt20">
            <div class="hd">
              ...
              <div class="fn-right f14 c-888">参与人次：<span class="c-555">8.06万次</span>
                &nbsp;&nbsp;&nbsp;平均转让用时：<span class="c-555">03小时06分22秒</span></div>
            </div>
            <div class="bd">
              <div class="des"><span class="fl">其他投资人折价转让，转让项目会随时更新，惊喜不断</span><a href="list.html"
                                                                                  class="fn-right">查看更多&gt;&gt;</a>
              </div>
              <div class="borrow-list">
                <ul>
                  <li>
                    <div class="title"><a href="infor.html" target="_blank"><i class="icon icon-zhuan"
                                                                               title="债权转让"></i></a><a
                      href="infor.html" title="汪女士债权质押借款1万元" class="f18" target="_blank">汪女士债权质押借款1万元</a></div>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                      <tr>
                        <td width="260" height="60">剩余期限<span class="f24 c-333"> 2月8天 </span></td>
                        <td width="200">预期收益率<span class="f24"><a href="javascript:;" class="tx-line c-orange"
                                                                  onClick="showCalculator(this,12.42,84890,10068.17)"
                                                                  title="点击查看纯收益率">12.42%</a></span></td>
                        <td width="280" align="center">转让价格<span class="f24 c-333">10,068.17</span>元</td>
                        <td width="88" align="right" class="time"><a href="#" class="ui-btn btn-gray"
                                                                     target="_blank">已转让</a>
        ...
        <div class="page-right fn-right" style="top: 0px;">
          <div class="mod-risk-tip"><i class="icon icon-tip"></i><a href="/bxbz/index.html"
          ...
          <div class="mod mod-notice mrt20">
            ...
            <div class="bd">
              <div class="article-list clearfix">
                <ul>
                  <li><a href="#" title="关于“金融产品”产品的说明">关于“金融产品”产品的说明</a><span class="date">06-19</span>
                  </li>
                  <li><a href="#" title="2015年9月10日发标预告">2015年9月10日发标预告</a><span class="date">09-10</span>
                  </li>
                  <li><a href="#" title="关于平台“纪念抗战胜利70周年”9月3日***">关于平台“纪念抗战胜利70周年***</a><span
                    class="date">09-02</span>
                  </li>
                  <li><a href="#" title="关于P2P理财平台新系统升级的公告">关于P2P理财平台新系统***</a><span
                    class="date">09-02</span></li>
                  <li><a href="#" title="关于债权贷新规调整实施的公告">关于债权贷新规调整实施的公告</a><span class="date">08-25</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="bd">
              <div class="ui-tab-cont">
                ...
                <div class="ui-tab-item">
                  <ul class="rank-list">
                    <li><span class="fl"><em class="n1">01</em>黄世******</span><span class="fr">￥78,714,974.00</span>
                    </li>
                    <li><span class="fl"><em class="n2">02</em>一诺******</span><span class="fr">￥58,428,720.00</span>
                    </li>
                    <li><span class="fl"><em class="n3">03</em>hj******</span><span class="fr">￥57,844,191.00</span>
                    </li>
                    <li><span class="fl"><em class="n4">04</em>老马******</span><span class="fr">￥38,808,064.00</span>
                    </li>
                    <li><span class="fl"><em class="n5">05</em>写意******</span><span class="fr">￥31,341,159.00</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="mod mod-report ui-tab clearfix mrt20">
            ...
            <div class="bd">
              <div class="ui-tab-cont">
                <div class="ui-tab-item active">
                  <div class="headlines"><img src="../static/images/news.jpg"> <a title="平台遭遇P2P滑稽抄袭"
                                                                                  target="_blank"
                                                                                  href="#">平台遭遇P2P滑稽抄袭</a><br>
                    <span class="des">抄袭者居然把被抄袭者的名字一起抄下来，这样的乌龙抄袭你见过没...</span></div>
                  <div class="article-list">
                    <ul>
                      <li>[凤凰网]<a href="#" title="平台携手哈工大关爱毕节留守儿童" target="_blank">平台携手哈工大关爱毕节留守儿童</a>
                      </li>
                      <li>[21CN财经]<a href="#" title="接受网贷之家专访" target="_blank">接受网贷之家专访</a></li>
                      <li>[和讯网]<a href="#" title="受邀参加中国财经峰会 斩获行业最具品牌影响力等两项大奖" target="_blank">受邀参加中国财经峰会
                        斩获行业最具品牌影响力等两项大奖</a></li>
                    </ul>
                  </div>
                </div>
                <div class="ui-tab-item">
          ...
          <div class="mrt20 mod">
            <a href="#">
              <img src="../static/images/pic_home_js.jpg" width="300" height="80" alt="收益计算器" class="pic"></a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="ui-tab-cont">
            <div class="ui-tab-item active">
              <div class="img-scroll">
                <div class="container">
                  <ul>
                    <li><img src="../static/images/logo_sbcvc.png" width="152" height="52" alt="软银">
                    </li>
                    <li><img src="../static/images/logo_abc.png" width="152" height="52" alt="农业银行">
                    </li>
                    <li><img src="../static/images/logo_wdzj.png" width="152" height="52"
                             alt="网贷之家"></li>
                    <li><img src="../static/images/logo_baidu.png" width="152" height="52" alt="百度">
                    </li>
                    <li><img src="../static/images/logo_aqb.png" width="152" height="52" alt="安全宝">
                    </li>
                    <li><img src="../static/images/logo_gds.png" width="152" height="52" alt="万国数据">
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <!-- 底部各银行信息部分 -->
            <div class="ui-tab-item">
              <div class="links"><a target="_blank" href="http://www.wd361.com">网贷互联</a>
    ...
    <div id="footer" class="ft">
          ...
          <dl>
            <dd>
              ...
              <div class="ft-serv-handle clearfix"><a class="icon-hdSprite icon-ft-sina a-move a-moveHover"
                ...
                class="icon-hdSprite icon-ft-qqweibo a-move a-moveHover" title="亿人宝腾讯微博" target="_blank" href="#"></a><a
                class="icon-ft-qun a-move a-moveHover" title="亿人宝QQ群" target="_blank" href="#"></a><a
                class="icon-hdSprite icon-ft-email a-move a-moveHover mrn" title="阳光易贷email" target="_blank"
          ...
          <dl>
            ...
            <dd>
              <span class="icon-ft-erweima">
                <img src="../static/images/code.png" style="display: inline;">
              </span>
            </dd>
          </dl>
        </div>
      ...
      <div class="ft-record">
        ...
        <div class="ft-identity">©2015 亿人宝 All rights reserved&nbsp;&nbsp;&nbsp;<span class="color-e6">|</span>&nbsp;&nbsp;&nbsp;安徽省亿人宝投资管理有限公司&nbsp;&nbsp;&nbsp;<span
          class="color-e6">|</span>&nbsp;&nbsp;&nbsp;<a target="_blank" href="http://www.miitbeian.gov.cn/">皖ICP备12345678号-1</a>
        </div>
      </div>
    </div>
