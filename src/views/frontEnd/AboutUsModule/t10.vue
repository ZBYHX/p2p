<template>
  <header>
    ...
    <ul class="clearfix join">
      <li>
        <div class="title">
          <img src="../static/images/join_01.jpg" class="fl" style="float:left">
        ...
        <p class="cn_line" style="text-indent:0;">
          &nbsp;&nbsp;&nbsp;<span
          style="line-height:2;">1.大专以上学历，1年以上大型呼叫中心或客服中心工作经验，具有一定的管理经验，熟悉呼叫中心业务指标及规范；</span><br>
      ...
      <li>
        <div class="title">
          <img src="../static/images/join_02.jpg" class="fl" style="float:left">
      ...
      <li>
        <div class="title">
          <img src="../static/images/join_03.jpg" class="fl" style="float:left">
      ...
      <li>
        <div class="title">
          <img src="../static/images/join_04.jpg" class="fl" style="float:left">
        ...
        <p class="cn_line" style="text-indent:0;">
          &nbsp;&nbsp;&nbsp;<span
          style="line-height:2;">1.学历不限，有1年以上SEO/SEM实操经验，熟悉SEO规则、原理、做法和效果评估标准，具备网站基础数据分析能力；</span><br>
      ...
      <li>
        <div class="title">
          <img src="../static/images/join_05.jpg" class="fl" style="float:left">
      ...
      <li>
        <div class="title">
          <img src="../static/images/join_06.jpg" class="fl" style="float:left">
      ...
      <li>
        <div class="title">
          <img src="../static/images/join_07.jpg" class="fl" style="float:left">
    ...
    <div class="join_end">
      <p class="cn_line" style="text-indent:0;">
        <span
          style="line-height:2;font-family:Microsoft YaHei;color:#0aaae1;font-size:24px;">热诚欢迎有志青年加盟！共创互联网金融宏伟蓝图。</span>
        <br>
        <span style="line-height:2;">如果您对我们的事业感兴趣，请将您的个人简历发送到人力资源部邮箱</span><span style="line-height:2;color:#0aaae1;">hr@yirendai.com</span><span
        style="line-height:2;">，我们将尽快与您联系。</span>
      </p>
    </div>
  </header>
</template>
