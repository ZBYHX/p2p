    ...
    <ul class="clearfix partner">
      <li class="mt10 partner-item clearfix">
        <a href="" class="logo" style="margin-top:50px">
          <img src="../static/images/ips.jpg" style="vertical-align:middle">
        </a>
        <div class="text">
          <h5>
            安徽大成律师事务所
      ...
      <li class="mt10 partner-item clearfix">
        ...
        <div class="text">
          ...
          <p class="cn_line" style="text-indent:0;">
            ...
            环迅支付总部位于上海，在长春、北京、南京、杭州、成都、重庆、福州、广州及深圳均拥有分支机构。公司现为中国首批获得VISA QSP认证（第三方支付公司资质认证方案，Qualified Service
            Provider）的第三方支付企业。
